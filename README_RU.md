...
<div align="center">
  <img src="./public/logo.svg" alt="ChargeChronicle — Windows laptops — Endurance" width="64" height="64">
  <h1>ChargeChronicle — Windows laptops — Endurance</h1>
</div>

Анализ пользовательских отчетов батареи без изменения прошивки и лимитов зарядки.
...
- **Battery report import** — запланированный модуль; реализации нет.
- **Capacity trend chart** — запланированный модуль; реализации нет.
- **Workload context annotations** — запланированный модуль; реализации нет.
...
3. Опишите один контрольный сценарий для **Battery report import**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="ChargeChronicle — Windows laptops — Endurance — specification review workflow">
<br>
...
Зафиксируйте входные данные и ожидаемый результат для модуля 1. Запишите версию Windows laptops, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Capacity trend chart

Зафиксируйте входные данные и ожидаемый результат для модуля 2. Запишите версию Windows laptops, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Workload context annotations

Зафиксируйте входные данные и ожидаемый результат для модуля 3. Запишите версию Windows laptops, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Кратко

| Поле | Значение |
|---|---|
| Продукт или область | Windows laptops |
| Категория | Утилиты для ПК |
| Входные данные | Ручные записи или разрешенный пользователем локальный экспорт |
| Планируемый результат | Battery report import |
